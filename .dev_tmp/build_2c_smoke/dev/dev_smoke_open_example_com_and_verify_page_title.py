...
# Workflow name: open_example_com_and_verify_page_title
# Workflow path (relative to this stub): ..\WORKFLOWS\open_example_com_and_verify_page_title.json
...
def main() -> int:
    ...
    workflow_path = (here.parent / r"""..\WORKFLOWS\open_example_com_and_verify_page_title.json""").resolve()
    ...
    if ok:
        print("PASS: SMOKE", "open_example_com_and_verify_page_title")
        if isinstance(result, dict):
            print("summary:", result.get("summary", result))
        return 0

    print("FAIL: SMOKE", "open_example_com_and_verify_page_title")
    if isinstance(result, dict):
        print("result:", result)
    return 1
