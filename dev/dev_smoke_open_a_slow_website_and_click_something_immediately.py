...
# Workflow name: open_a_slow_website_and_click_something_immediately  
# Workflow path (relative to this stub): ..\WORKFLOWS\open_a_slow_website_and_click_something_immediately.json  
...
def main() -> int:  
    ...
    workflow_path = (here.parent / r"""..\WORKFLOWS\open_a_slow_website_and_click_something_immediately.json""").resolve()  
    ...
    if ok:  
        print("PASS: SMOKE", "open_a_slow_website_and_click_something_immediately")  
        if isinstance(result, dict):  
            print("summary:", result.get("summary", result))  
        return 0  
  
    print("FAIL: SMOKE", "open_a_slow_website_and_click_something_immediately")  
    if isinstance(result, dict):  
        print("result:", result)  
    return 1  
