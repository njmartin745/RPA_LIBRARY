...
# Workflow name: open_google_and_click_search  
# Workflow path (relative to this stub): ..\WORKFLOWS\open_google_and_click_search.json  
...
def main() -> int:  
    ...
    workflow_path = (here.parent / r"""..\WORKFLOWS\open_google_and_click_search.json""").resolve()  
    ...
    if ok:  
        print("PASS: SMOKE", "open_google_and_click_search")  
        if isinstance(result, dict):  
            print("summary:", result.get("summary", result))  
        return 0  
  
    print("FAIL: SMOKE", "open_google_and_click_search")  
    if isinstance(result, dict):  
        print("result:", result)  
    return 1  
