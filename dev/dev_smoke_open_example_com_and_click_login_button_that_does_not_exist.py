...
# Workflow name: open_example_com_and_click_login_button_that_does_not_exist  
# Workflow path (relative to this stub): ..\WORKFLOWS\open_example_com_and_click_login_button_that_does_not_exist.json  
...
def main() -> int:  
    ...
    workflow_path = (here.parent / r"""..\WORKFLOWS\open_example_com_and_click_login_button_that_does_not_exist.json""").resolve()  
    ...
    if ok:  
        print("PASS: SMOKE", "open_example_com_and_click_login_button_that_does_not_exist")  
        if isinstance(result, dict):  
            print("summary:", result.get("summary", result))  
        return 0  
  
    print("FAIL: SMOKE", "open_example_com_and_click_login_button_that_does_not_exist")  
    if isinstance(result, dict):  
        print("result:", result)  
    return 1  
